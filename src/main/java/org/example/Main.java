...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread a = new Thread(() -> {
            char letter1 = 'a';
            int maxA = findMaxCharCount(queueA, letter1);
            System.out.println("Максимальное количество символов " + "'" + letter1 + "'" + " в тексте: " + maxA);
        });
        a.start();

        Thread b = new Thread(() -> {
            char letter2 = 'b';
            int maxB = findMaxCharCount(queueB, letter2);
            System.out.println("Максимальное количество символов " + "'" + letter2 + "'" + " в тексте: " + maxB);
        });
        b.start();

        Thread c = new Thread(() -> {
            char letter3 = 'c';
            int maxC = findMaxCharCount(queueC, letter3);
            System.out.println("Максимальное количество символов " + "'" + letter3 + "'" + " в тексте: " + maxC);
        });
        c.start();
